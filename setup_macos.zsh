...
# This doesn't really annoy me so I'm commenting out for now.
...
# set battery pmsetd
sudo pmset -b displaysleep 5 disksleep 10 sleep 20

# set charging pmsetd
sudo pmset -c displaysleep 10 disksleep 20 sleep 40
...
# defaults write org.m0k.transmission BlocklistAutoUpdate -bool false
